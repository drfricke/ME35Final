...
def prediction(frame):
    ...
    print(prediction)
    #return index of most likely prediction
...
#System Check - waits for remote user
while True:
...
while(True):
    ...
    if Get_SL('Start08') == 'false':
       #EV3 will reset system link when the ball is released
       #This engages image capture on laptop
       time.sleep(2) #Time for ball to fall
